...
import AppQuantitySelector from '../common/AppQuantitySelector.vue'
...
<template>
  ...
  >
    ...
    <div class="bg-secondary rounded-lg pa-4 d-flex">
      <VIcon icon="mdi-alert" class="mr-3 mt-1" color="primary" size="small" />
