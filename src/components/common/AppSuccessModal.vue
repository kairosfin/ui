...
<template>
  <VDialog v-model="isOpen" max-width="400" persistent>
    ...
    >
      <div class="mb-4">
        <VAvatar color="success-lighten-5" size="80" class="mb-2" aria-hidden="true">
          <VIcon icon="mdi-check-circle" color="success" size="48" />
        </VAvatar>
      </div>

      <h3 id="success-modal-title" class="text-h5 font-weight-bold mb-2">
        {{ title }}
      </h3>
      ...
      <AppButton :text="buttonText" block @click="handleConfirm" />
    </VCard>
  </VDialog>
</template>
